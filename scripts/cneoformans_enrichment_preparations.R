...
raw_interpro <- read_lines("~/Desktop/alternative_splicing/cneoformans/Cryptococcus_neoformans_H99.proteins.fasta.tsv")
...
dictionary <- read_tsv("~/Desktop/alternative_splicing/cneoformans/cneoformans_dictionary.tsv", col_names = T, cols(fasta_transcript_id = col_character(),gene_id = col_character(),annotation_transcript_id = col_character()))
...
write_tsv(GO_final_formated, "~/Desktop/alternative_splicing/cneoformans/cneoformans_GO_dict.tsv", col_names = F)
