...
isoforms_tracking <- read_tsv("Desktop/alternative_splicing/aostoyae/aostoyae_RRPM_CUFFout/isoforms.fpkm_tracking")

annotation <- read_tsv("Desktop/alternative_splicing/aostoyae/aostoyae_genome/aostoyae_RRPM_transcripts.gtf", 
