...
##########################################################
#     COPRINOPSIS GO-kat tartalmazó fájl elkészítése     #
##########################################################

raw_interpro <- read_lines("~/Desktop/alternative_splicing/pchrysosporium/Phchr2_GeneCatalog_proteins_20131210.aa.fasta.tsv")
...
dictionary <- read_tsv("~/Desktop/alternative_splicing/pchrysosporium/pchrysosporium_dictionary.tsv", col_names = T, cols(fasta_transcript_id = col_character(),gene_id = col_character(),annotation_transcript_id = col_character()))
...
write_tsv(GO_final_formated, "~/Desktop/alternative_splicing/pchrysosporium/pchrysosporium_GO_dict.tsv", col_names = F)

##########################################################
#     COPRINOPSIS GO-kat tartalmazó fájl elkészítése     #
##########################################################

raw_interpro <- read_lines("~/Desktop/alternative_splicing/pchrysosporium/pchrysosporium_proteins_all.fasta.tsv")
...
write_tsv(GO_final_merged, "~/Desktop/alternative_splicing/pchrysosporium/pchrysosporium_transcript_GO_dict.tsv", col_names = F)
