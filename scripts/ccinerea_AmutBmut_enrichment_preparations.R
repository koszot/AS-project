...
raw_interpro <- read_lines("~/Desktop/alternative_splicing/ccinerea_AmutBmut/Copci_AmutBmut1_GeneCatalog_proteins_20130522.aa.fasta.tsv")
...
dictionary <- read_tsv("Desktop/alternative_splicing/ccinerea_AmutBmut/ccinerea_AmutBmut_dictionary.tsv", col_names = T, cols(fasta_transcript_id = col_character(),gene_id = col_character(),annotation_transcript_id = col_character()))
...
write_tsv(GO_final_formated, "~/Desktop/alternative_splicing/ccinerea_AmutBmut/ccinerea_GO_dict.tsv", col_names = F)
...
write_tsv(GO_final_merged, "~/Desktop/alternative_splicing/ccinerea_AmutBmut/ccinerea_transcript_GO_dict.tsv", col_names = F)
