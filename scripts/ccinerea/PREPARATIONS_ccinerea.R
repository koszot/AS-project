...
original <- read_tsv("Copci_AmutBmut1_genome/Copci_AmutBmut1_GeneCatalog_genes_20130522.gff", col_names = c("chr", "maker", "type", "start", "end", "att1", "strand",  "att2", "attributes"))
...
write.table(original_fixed, file = "Copci_AmutBmut1_genome/ccinerea_AmutBmut_onlyexon.gtf", sep = "\t", row.names = FALSE, col.names = FALSE, quote = FALSE)
...
write.table(genes, file = "./Copci_AmutBmut1_genome/ccinerea_AmutBmut_onlygene.gtf", sep = "\t", row.names = FALSE, col.names = FALSE, quote = FALSE)
...
write.table(exon_fixed, file = "./Copci_AmutBmut1_genome/ccinerea_AmutBmut_fixed.gtf", row.names = FALSE, col.names = FALSE, quote = FALSE, sep = "\t")
