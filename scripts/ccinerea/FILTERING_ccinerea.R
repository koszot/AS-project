...
setwd("~/Desktop/alternative_splicing/ccinerea_AmutBmut/")  # beállítjuk a working directoryt

genes <- read_tsv("ccinerea_AmutBmut_genome/ccinerea_AmutBmut_onlygene.gtf", 
                  col_names = c("chr", "maker", "type", "start", "end", "att1", "strand", "att2", "attributes"))     # beolvassuk az eredeti GTF fájlt

raw <- read_tsv("ccinerea_AmutBmut_RRPM_CUFFout/transcripts.gtf", 
...
write.table(strand_filtered_final, file = "./ccinerea_AmutBmut_genome/ccinerea_RRPM_transcripts.gtf", row.names = FALSE, col.names = FALSE, quote = FALSE, sep = "\t")
...
original <- read_tsv("ccinerea_AmutBmut_genome/ccinerea_AmutBmut_onlyexon.gtf", 
                  col_names = c("chr", "maker", "type", "start", "end", "att1", "strand", "att2", "attributes"))     # beolvassuk az eredeti GTF fájlt
...
write.table(merged, file = "./ccinerea_AmutBmut_genome/ccinerea_AmutBmut_AS_annotation.gtf", row.names = FALSE, col.names = FALSE, quote = FALSE, sep = "\t")

write_tsv(stats, "ccinerea_stats.log")
