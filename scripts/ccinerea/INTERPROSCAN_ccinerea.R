...
headers <- read_tsv("ccinerea_AmutBmut_enrichment_analysis/ccinerea_AmutBmut_transcripts.fasta.transdecoder_dir/headers.cds", col_names = F)
...
write_lines(filter, "ccinerea_AmutBmut_enrichment_analysis/ccinerea_AmutBmut_transcripts.fasta.transdecoder_dir/filter")
