...
isoforms.fpkm <- read_tsv("scommune_CUFFdiff/isoforms.fpkm_tracking", col_names = T, cols(tracking_id = col_character(), gene_id = col_character()))     # betöltjük az isoform FPKM táblát
genes.fpkm <- read_tsv("scommune_CUFFdiff/genes.fpkm_tracking", col_names = T, cols(tracking_id = col_character(), gene_id = col_character()))           # betöltjük az genes FPKM táblát
...
write_tsv(geneUniverse, "scommune_enrichment/scommune_genelvl_enrichment_geneUniverse.tsv")
write_tsv(AS.transcripts, "scommune_enrichment/scommune_genelvl_enrichment_AStranscripts.tsv")
write_tsv(DEVREG.transcripts, "scommune_enrichment/scommune_genelvl_enrichment_DEVREGtranscripts.tsv")
