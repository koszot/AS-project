  ...
  isoforms_tracking <- read_tsv("Desktop/alternative_splicing/pchrysosporium/pchrysosporium_RRPM_CUFFout/isoforms.fpkm_tracking")
  
  annotation <- read_tsv("Desktop/alternative_splicing/pchrysosporium/pchrysosporium_genome/pchrysosporium_AS_annotation.gtf", 
