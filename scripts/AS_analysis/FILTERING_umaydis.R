...
setwd("~/Desktop/alternative_splicing/umaydis/")  # beállítjuk a working directoryt

genes <- read_tsv("umaydis_genome/umaydis_onlygene.gtf", 
                  col_names = c("chr", "maker", "type", "start", "end", "att1", "strand", "att2", "attributes"))     # beolvassuk az eredeti GTF fájlt

raw <- read_tsv("umaydis_RRPM_CUFFout/transcripts.gtf", 
...
write.table(strand_filtered_final, file = "./umaydis_genome/umaydis_RRPM_transcripts.gtf", row.names = FALSE, col.names = FALSE, quote = FALSE, sep = "\t")
...
original <- read_tsv("umaydis_genome/umaydis_onlyexon.gtf", 
                  col_names = c("chr", "maker", "type", "start", "end", "att1", "strand", "att2", "attributes"))     # beolvassuk az eredeti GTF fájlt
...
write.table(merged, file = "./umaydis_genome/umaydis_AS_annotation.gtf", row.names = FALSE, col.names = FALSE, quote = FALSE, sep = "\t")
