...
headers <- read_tsv("aostoyae_enrichment_analysis/aostoyae_transcripts.fasta.transdecoder_dir/headers.cds", col_names = F)
...
write_lines(filter, "aostoyae_enrichment_analysis/aostoyae_transcripts.fasta.transdecoder_dir/filter")
