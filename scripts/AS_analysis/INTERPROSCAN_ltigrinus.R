...
headers <- read_tsv("ltigrinus_enrichment_analysis/ltigrinus_transcripts.fasta.transdecoder_dir/headers.cds", col_names = F)
...
write_lines(filter, "ltigrinus_enrichment_analysis/ltigrinus_transcripts.fasta.transdecoder_dir/filter")
