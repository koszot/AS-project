...
setwd("~/Desktop/alternative_splicing/cneoformans/")  # beállítjuk a working directoryt

genes <- read_tsv("cneoformans_genome/cneoformans_onlygene.gtf", 
                  col_names = c("chr", "maker", "type", "start", "end", "att1", "strand", "att2", "attributes"))     # beolvassuk az eredeti GTF fájlt

raw <- read_tsv("cneoformans_RRPM_CUFFout/transcripts.gtf", 
...
write.table(strand_filtered_final, file = "./cneoformans_genome/cneoformans_RRPM_transcripts.gtf", row.names = FALSE, col.names = FALSE, quote = FALSE, sep = "\t")
...
original <- read_tsv("cneoformans_genome/cneoformans_onlyexon.gtf", 
                  col_names = c("chr", "maker", "type", "start", "end", "att1", "strand", "att2", "attributes"))     # beolvassuk az eredeti GTF fájlt
...
write.table(merged, file = "./cneoformans_genome/cneoformans_AS_annotation.gtf", row.names = FALSE, col.names = FALSE, quote = FALSE, sep = "\t")
