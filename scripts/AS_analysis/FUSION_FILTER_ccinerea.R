...
isoforms_tracking <- read_tsv("Desktop/alternative_splicing/ccinerea_AmutBmut/ccinerea_AmutBmut_RRPM_CUFFout/isoforms.fpkm_tracking")

annotation <- read_tsv("Desktop/alternative_splicing/ccinerea_AmutBmut/ccinerea_AmutBmut_genome/ccinerea_AmutBmut_AS_annotation.gtf", 
