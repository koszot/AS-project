...
original <- read_tsv("pchrysosporium_genome/Phchr2_GeneCatalog_genes_20131210.gff", col_names = c("chr", "maker", "type", "start", "end", "att1", "strand",  "att2", "attributes"))
...
write.table(original_fixed, file = "pchrysosporium_genome/pchrysosporium_onlyexon.gtf", sep = "\t", row.names = FALSE, col.names = FALSE, quote = FALSE)
...
write.table(genes, file = "./pchrysosporium_genome/pchrysosporium_onlygene.gtf", sep = "\t", row.names = FALSE, col.names = FALSE, quote = FALSE)
...
write.table(exon_fixed, file = "./pchrysosporium_genome/pchrysosporium_fixed.gtf", row.names = FALSE, col.names = FALSE, quote = FALSE, sep = "\t")
