...
setwd("~/Desktop/alternative_splicing/pchrysosporium/")  # beállítjuk a working directoryt

genes <- read_tsv("pchrysosporium_genome/pchrysosporium_onlygene.gtf", 
                  col_names = c("chr", "maker", "type", "start", "end", "att1", "strand", "att2", "attributes"))     # beolvassuk az eredeti GTF fájlt

raw <- read_tsv("pchrysosporium_RRPM_CUFFout/transcripts.gtf", 
...
write.table(strand_filtered_final, file = "./pchrysosporium_genome/pchrysosporium_RRPM_transcripts.gtf", row.names = FALSE, col.names = FALSE, quote = FALSE, sep = "\t")
...
original <- read_tsv("pchrysosporium_genome/pchrysosporium_onlyexon.gtf", 
                  col_names = c("chr", "maker", "type", "start", "end", "att1", "strand", "att2", "attributes"))     # beolvassuk az eredeti GTF fájlt
...
write.table(merged, file = "./pchrysosporium_genome/pchrysosporium_AS_annotation.gtf", row.names = FALSE, col.names = FALSE, quote = FALSE, sep = "\t")
