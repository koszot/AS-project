...
headers <- read_tsv("pchrysosporium_transcripts.fasta.transdecoder_dir/headers.cds", col_names = F)
...
write_lines(filter, "pchrysosporium_transcripts.fasta.transdecoder_dir/filter")
