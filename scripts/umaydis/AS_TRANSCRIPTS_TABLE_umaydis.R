...
stats <- read_tsv("umaydis_stats.log")                                                 # a stats list bevezetése
...
cds <- read_tsv("umaydis_transcripts.fasta.transdecoder_dir/headers.cds", col_names = F)
...
raw_interpro <- read_lines("umaydis_proteins_all.fasta.tsv")
...
write_tsv(df3, "umaydis_results.tsv")

write_tsv(stats, "umaydis_stats.log")
