...
headers <- read_tsv("cneoformans_transcripts.fasta.transdecoder_dir/headers.cds", col_names = F)
...
write_lines(filter, "cneoformans_transcripts.fasta.transdecoder_dir/filter")
