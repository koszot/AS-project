...
original <- read_tsv("cneoformans_genome/Cryptococcus_neoformans_H99.genes.gff", col_names = c("chr", "maker", "type", "start", "end", "att1", "strand",  "att2", "attributes"))
...
write.table(original_fixed, file = "cneoformans_genome/cneoformans_onlyexon.gtf", sep = "\t", row.names = FALSE, col.names = FALSE, quote = FALSE)
...
write.table(genes, file = "./cneoformans_genome/cneoformans_onlygene.gtf", sep = "\t", row.names = FALSE, col.names = FALSE, quote = FALSE)
...
write.table(exon_fixed, file = "./cneoformans_genome/cneoformans_fixed.gtf", row.names = FALSE, col.names = FALSE, quote = FALSE, sep = "\t")
