  ...
  isoforms_tracking <- read_tsv("Desktop/alternative_splicing/aampla/aampla_RRPM_CUFFout/isoforms.fpkm_tracking")
  
  annotation <- read_tsv("Desktop/alternative_splicing/aampla/aampla_genome/aampla_AS_annotation.gtf", 
