...
write_tsv(geneUniverse, "cneoformans_enrichment/cneoformans_genelvl_enrichment_geneUniverse.tsv")

AS.transcripts <- as_tibble(unique(AS.transcripts$gene_id))
write_tsv(AS.transcripts, "cneoformans_enrichment/cneoformans_genelvl_enrichment_AStranscripts.tsv")
