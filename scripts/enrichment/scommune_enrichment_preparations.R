...
############################################################
#     SCHYZOPHYLLUM GO-kat tartalmazó fájl elkészítése     #
############################################################

raw_interpro <- read_lines("~/Desktop/alternative_splicing/scommune/Schco3_GeneCatalog_proteins_20130812.aa.fasta.tsv")
...
dictionary <- read_tsv("Desktop/alternative_splicing/scommune/scommune_dictionary.tsv", col_names = T, cols(fasta_transcript_id = col_character(),gene_id = col_character(),annotation_transcript_id = col_character()))
...
write_tsv(GO_final_formated, "~/Desktop/alternative_splicing/scommune/scommune_GO_dict.tsv", col_names = F)
...
write_tsv(GO_final_merged, "~/Desktop/alternative_splicing/scommune/scommune_transcript_GO_dict.tsv", col_names = F)
