...
isoforms.fpkm <- read_tsv("ltigrinus_CUFFdiff/isoforms.fpkm_tracking", col_names = T, cols(tracking_id = col_character(), gene_id = col_character()))     # betöltjük az isoform FPKM táblát
genes.fpkm <- read_tsv("ltigrinus_CUFFdiff/genes.fpkm_tracking", col_names = T, cols(tracking_id = col_character(), gene_id = col_character()))           # betöltjük az genes FPKM táblát
...
write_tsv(geneUniverse, "ltigrinus_enrichment/ltigrinus_genelvl_enrichment_geneUniverse.tsv")
write_tsv(AS.transcripts, "ltigrinus_enrichment/ltigrinus_genelvl_enrichment_AStranscripts.tsv")
write_tsv(DEVREG.transcripts, "ltigrinus_enrichment/ltigrinus_genelvl_enrichment_DEVREGtranscripts.tsv")
