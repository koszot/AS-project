...
write_tsv(geneUniverse, "rmellea_enrichment/rmellea_genelvl_enrichment_geneUniverse.tsv")

AS.transcripts <- as_tibble(unique(AS.transcripts$gene_id))
write_tsv(AS.transcripts, "rmellea_enrichment/rmellea_genelvl_enrichment_AStranscripts.tsv")

DEVREG.transcripts <- as_tibble(unique(DEVREG.transcripts$gene_id))
write_tsv(DEVREG.transcripts, "rmellea_enrichment/rmellea_genelvl_enrichment_DEVREGtranscripts.tsv")
