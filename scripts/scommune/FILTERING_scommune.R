...
setwd("~/Desktop/working/scommune/")  # beállítjuk a working directoryt
...
write.table(strand_filtered_final, file = "./genome/RRPM_transcripts.gtf", row.names = FALSE, col.names = FALSE, quote = FALSE, sep = "\t")
...
write.table(merged, file = "./genome/RRPM_transcripts.fixed.gtf", row.names = FALSE, col.names = FALSE, quote = FALSE, sep = "\t")
