...
isoforms_tracking <- read_tsv("Desktop/working/scommune/RRPM_CUFFout/isoforms.fpkm_tracking")

annotation <- read_tsv("Desktop/working/scommune/genome/RRPM_transcripts.fixed.gtf", 
