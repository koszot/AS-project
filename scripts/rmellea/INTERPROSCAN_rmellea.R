...
headers <- read_tsv("rmellea_transcripts.fasta.transdecoder_dir/headers.cds", col_names = F)
...
write_lines(filter, "rmellea_transcripts.fasta.transdecoder_dir/filter")
