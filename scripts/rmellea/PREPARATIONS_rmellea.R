...
original <- read_tsv("rmellea_genome/Ricmel1_GeneCatalog_genes_20151108.gff", col_names = c("chr", "maker", "type", "start", "end", "att1", "strand",  "att2", "attributes"))
...
write.table(original_fixed, file = "rmellea_genome/rmellea_onlyexon.gtf", sep = "\t", row.names = FALSE, col.names = FALSE, quote = FALSE)
...
write.table(genes, file = "./rmellea_genome/rmellea_onlygene.gtf", sep = "\t", row.names = FALSE, col.names = FALSE, quote = FALSE)
...
write.table(exon_fixed, file = "./rmellea_genome/rmellea_fixed.gtf", row.names = FALSE, col.names = FALSE, quote = FALSE, sep = "\t")
