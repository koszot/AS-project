...
raw_interpro <- read_lines("Auramp1_GeneCatalog_proteins_20160719.aa.fasta.tsv")
...
dictionary <- read_tsv("aampla_dictionary.tsv", col_names = T, cols(fasta_transcript_id = col_character(),gene_id = col_character(),annotation_transcript_id = col_character()))
...
write_tsv(GO_final_formated, "aampla_GO_dict.tsv", col_names = F)
