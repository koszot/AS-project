...
#########################################################
#     ARMILLARIA GO-kat tartalmazó fájl elkészítése     #
#########################################################

raw_interpro <- read_lines("~/Desktop/alternative_splicing/aostoyae/p3_i2_t47428_Arm_ostoy_v2.prot.tsv")
...
write_tsv(GO_final_merged, "~/Desktop/alternative_splicing/aostoyae/aostoyae_GO_dict.tsv", col_names = F)
...
write_tsv(GO_final_merged, "~/Desktop/alternative_splicing/aostoyae/aostoyae_transcript_GO_dict.tsv", col_names = F)
